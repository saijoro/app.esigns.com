...
const L = () => {
  const c = useNavigate({ from: "/" }), h = useRouter(), { control: m, handleSubmit: u, setError: o$1, formState: { errors: i } } = useForm({}), [n$1, g] = useState(false), [y, d$1] = useState(false), { mutate: b, isError: _, error: V } = useMutation({ mutationFn: async (r) => {
    var _a, _b, _c, _d;
    try {
      d$1(true);
      const t = await n(r);
  ...
  return jsx("div", { className: "flex justify-center items-center h-full", children: jsxs("div", { className: "p-8 top-[100px] w-[400px]  absolute bg-white rounded-2xl shadow flex-col justify-center items-center gap-12 inline-flex border", children: [jsxs("div", { className: "self-stretch h-[71px] flex-col justify-start items-center gap-4 flex", children: [jsx("div", { className: "self-stretch text-center text-black text-[32px] font-normal leading-loose", children: "Login" }), jsx("div", { className: "self-stretch text-center text-[#333333] text-lg font-light leading-normal", children: "Greetings! Kindly enter your credentials." })] }), jsx("div", { className: "self-stretch flex-col justify-start items-center gap-6 flex", children: jsx("form", { onSubmit: u(N), className: "self-stretch flex-col justify-start items-center gap-6 flex", children: jsxs("div", { className: "self-stretch h-[297px] flex-col justify-start items-start gap-12 flex", children: [jsxs("div", { className: "self-stretch h-[201px] flex-col justify-start items-start gap-6 flex", children: [jsxs("div", { className: "self-stretch h-[72px] flex-col justify-start items-start gap-1.5 flex", children: [jsx("div", { className: "self-stretch text-black text-sm font-normal leading-[18.20px]", children: "Email" }), jsx(Controller, { name: "email", control: m, render: ({ field: r }) => {
    ...
    var _a;
    return jsxs("div", { className: "w-full relative", children: [jsx(d, { ...r, type: n$1 ? "text" : "password", placeholder: "Enter password", className: "h-12 px-4 py-3.5 bg-white rounded-lg border border-black/30 w-full" }), jsx("button", { type: "button", onClick: v, className: "absolute right-3 top-1/2 transform -translate-y-1/2 text-slate-800", children: n$1 ? jsx(Eye, {}) : jsx(EyeOff, {}) }), i.password && jsx("div", { className: "text-red-500 text-sm mt-1 capitalize", children: (_a = i == null ? void 0 : i.password) == null ? void 0 : _a.message })] });
  } }), jsx("div", { className: "self-stretch text-right text-black text-base font-medium leading-tight", children: "Forgot Password ?" })] })] })] }), jsx(f, { type: "submit", className: "text-black h-12 px-2.5 py-3.5 bg-[#ffc900] rounded-lg text-base font-medium leading-tight w-full", children: y ? jsx(Loader2, { className: "mr-2 h-5 w-5 animate-spin" }) : "Login" })] }) }) }), jsxs("div", { className: "flex justify-center items-center gap-2", children: [jsxs("div", { className: "text-center text-[#0d0d0d] text-base font-light", children: ["New to eSigns?", " "] }), jsx("div", { className: "text-center text-[#2f80ed] text-base font-normal cursor-pointer", onClick: () => h.navigate({ to: "/signup" }), children: "Sign up here." })] })] }) });
}, X = function() {
  return jsx(L, {});
};

export { X as component };
//# sourceMappingURL=signin-DDyG763-.mjs.map
