...
import { defaultTransformer, isRedirect as isRedirect$1, isNotFound, createRootRouteWithContext, Outlet, ScrollRestoration, createFileRoute, lazyRouteComponent, useRouter, useRouterState, RouterProvider, createMemoryHistory, ScriptOnce, createRouter as createRouter$2, pick, isPlainArray, isPlainObject as isPlainObject$1, defer as defer$1, createControlledPromise } from '@tanstack/react-router';
import g from 'tiny-invariant';
import { AsyncLocalStorage } from 'node:async_hooks';
import { jsx, Fragment, jsxs } from 'react/jsx-runtime';
import * as i$3 from 'react';
import { createContext as createContext$1, createElement, useState } from 'react';
import b from 'jsesc';
...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com","order":0,"outDir":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com","outDir":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com","base":"/","outDir":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start/dist/esm/server-handler/index.js","root":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com","outDir":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com/.vinxi/build/server","order":3}],"server":{"preset":"vercel","experimental":{"asyncContext":true}},"root":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com"};
				const buildManifest = {"client":{"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com/app/routes/styles/app.css":{"file":"assets/app-Cs24V_o8.css","src":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com/app/routes/styles/app.css"},"_auth-CEVdNBYg.js":{"file":"assets/auth-CEVdNBYg.js","name":"auth","imports":["_client-kLIpqcrO.js","_fetch-B5HKRcBN.js","_createLucideIcon-Bx541-LO.js"]},"_button-DOQPPOcB.js":{"file":"assets/button-DOQPPOcB.js","name":"button","imports":["_client-kLIpqcrO.js","_index-Bd5dYd50.js"]},"_client-kLIpqcrO.js":{"file":"assets/client-kLIpqcrO.js","name":"client","dynamicImports":["app/routes/_layout.tsx?tsr-split","app/routes/_auth.tsx?tsr-split","app/routes/_layout/dashboard.tsx?tsr-split","app/routes/_layout/_sub-layout.tsx?tsr-split","app/routes/_auth/verify.tsx?tsr-split","app/routes/_auth/signup.tsx?tsr-split","app/routes/_auth/signin.tsx?tsr-split","app/routes/_layout/_sub-layout/index.tsx?tsr-split","app/routes/_layout/_sub-layout/templates.tsx?tsr-split","app/routes/_layout/_sub-layout/create-document.tsx?tsr-split"],"assets":["assets/app-Cs24V_o8.css"]},"_createLucideIcon-Bx541-LO.js":{"file":"assets/createLucideIcon-Bx541-LO.js","name":"createLucideIcon","imports":["_client-kLIpqcrO.js"]},"_eye-DFiJOWym.js":{"file":"assets/eye-DFiJOWym.js","name":"eye","imports":["_createLucideIcon-Bx541-LO.js"]},"_fetch-B5HKRcBN.js":{"file":"assets/fetch-B5HKRcBN.js","name":"fetch"},"_index-Bd5dYd50.js":{"file":"assets/index-Bd5dYd50.js","name":"index","imports":["_client-kLIpqcrO.js"]},"_index-Co9RiU_9.js":{"file":"assets/index-Co9RiU_9.js","name":"index","imports":["_client-kLIpqcrO.js","_index-Bd5dYd50.js","_react-icons.esm-DnATOGxL.js"]},"_react-icons.esm-DnATOGxL.js":{"file":"assets/react-icons.esm-DnATOGxL.js","name":"react-icons.esm","imports":["_client-kLIpqcrO.js","_index-Bd5dYd50.js"]},"_select-D0T-51VM.js":{"file":"assets/select-D0T-51VM.js","name":"select","imports":["_client-kLIpqcrO.js","_react-icons.esm-DnATOGxL.js","_index-Bd5dYd50.js","_tslib.es6-CmEaCU22.js"]},"_tslib.es6-CmEaCU22.js":{"file":"assets/tslib.es6-CmEaCU22.js","name":"tslib.es6"},"_useLocation-BNFdhEc7.js":{"file":"assets/useLocation-BNFdhEc7.js","name":"useLocation","imports":["_client-kLIpqcrO.js"]},"app/routes/_auth.tsx?tsr-split":{"file":"assets/_auth-Bm2U8B2l.js","name":"_auth","src":"app/routes/_auth.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-kLIpqcrO.js"]},"app/routes/_auth/signin.tsx?tsr-split":{"file":"assets/signin-_p5LBg5d.js","name":"signin","src":"app/routes/_auth/signin.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-kLIpqcrO.js","_button-DOQPPOcB.js","_index-Bd5dYd50.js","_auth-CEVdNBYg.js","_fetch-B5HKRcBN.js","_eye-DFiJOWym.js","_createLucideIcon-Bx541-LO.js"]},"app/routes/_auth/signup.tsx?tsr-split":{"file":"assets/signup-CfW2TU-v.js","name":"signup","src":"app/routes/_auth/signup.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-kLIpqcrO.js","_auth-CEVdNBYg.js","_react-icons.esm-DnATOGxL.js","_index-Bd5dYd50.js","_index-Co9RiU_9.js","_eye-DFiJOWym.js","_fetch-B5HKRcBN.js","_createLucideIcon-Bx541-LO.js"]},"app/routes/_auth/verify.tsx?tsr-split":{"file":"assets/verify-CkQQeWTb.js","name":"verify","src":"app/routes/_auth/verify.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-kLIpqcrO.js","_button-DOQPPOcB.js","_index-Bd5dYd50.js","_auth-CEVdNBYg.js","_useLocation-BNFdhEc7.js","_fetch-B5HKRcBN.js","_createLucideIcon-Bx541-LO.js"]},"app/routes/_layout.tsx?tsr-split":{"file":"assets/_layout-Boo7IdOU.js","name":"_layout","src":"app/routes/_layout.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-kLIpqcrO.js","_react-icons.esm-DnATOGxL.js","_index-Bd5dYd50.js","_select-D0T-51VM.js","_button-DOQPPOcB.js","_index-Co9RiU_9.js","_useLocation-BNFdhEc7.js","_createLucideIcon-Bx541-LO.js","_tslib.es6-CmEaCU22.js"]},"app/routes/_layout/_sub-layout.tsx?tsr-split":{"file":"assets/_sub-layout-GnKc2aPC.js","name":"_sub-layout","src":"app/routes/_layout/_sub-layout.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-kLIpqcrO.js"]},"app/routes/_layout/_sub-layout/create-document.tsx?tsr-split":{"file":"assets/create-document-xz6PSRxR.js","name":"create-document","src":"app/routes/_layout/_sub-layout/create-document.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-kLIpqcrO.js","_tslib.es6-CmEaCU22.js","_createLucideIcon-Bx541-LO.js"]},"app/routes/_layout/_sub-layout/index.tsx?tsr-split":{"file":"assets/index-BZ5k6xSU.js","name":"index","src":"app/routes/_layout/_sub-layout/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-kLIpqcrO.js"]},"app/routes/_layout/_sub-layout/templates.tsx?tsr-split":{"file":"assets/templates-GPKsuxlM.js","name":"templates","src":"app/routes/_layout/_sub-layout/templates.tsx?tsr-split","isDynamicEntry":true},"app/routes/_layout/dashboard.tsx?tsr-split":{"file":"assets/dashboard-6xqT0xLZ.js","name":"dashboard","src":"app/routes/_layout/dashboard.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-kLIpqcrO.js","_fetch-B5HKRcBN.js","_index-Bd5dYd50.js","_useLocation-BNFdhEc7.js","_button-DOQPPOcB.js","_react-icons.esm-DnATOGxL.js","_select-D0T-51VM.js","_tslib.es6-CmEaCU22.js"]},"virtual:$vinxi/handler/client":{"file":"assets/client-Dhg7oJtx.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-kLIpqcrO.js"]}},"ssr":{"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com/app/routes/styles/app.css":{"file":"assets/app-Cs24V_o8.css","src":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com/app/routes/styles/app.css"},"_auth-B0wetoCf.js":{"file":"assets/auth-B0wetoCf.js","name":"auth","imports":["_fetch-DqQ3Y-nf.js"]},"_button-cyuXPM3g.js":{"file":"assets/button-cyuXPM3g.js","name":"button","imports":["_input-BNpTjTIy.js"]},"_fetch-DqQ3Y-nf.js":{"file":"assets/fetch-DqQ3Y-nf.js","name":"fetch"},"_input-BNpTjTIy.js":{"file":"assets/input-BNpTjTIy.js","name":"input"},"_select-2qGakAU5.js":{"file":"assets/select-2qGakAU5.js","name":"select","imports":["_input-BNpTjTIy.js"]},"_ssr-C9q5VXgz.js":{"file":"assets/ssr-C9q5VXgz.js","name":"ssr","dynamicImports":["app/routes/_layout.tsx?tsr-split","app/routes/_auth.tsx?tsr-split","app/routes/_layout/dashboard.tsx?tsr-split","app/routes/_layout/_sub-layout.tsx?tsr-split","app/routes/_auth/verify.tsx?tsr-split","app/routes/_auth/signup.tsx?tsr-split","app/routes/_auth/signin.tsx?tsr-split","app/routes/_layout/_sub-layout/index.tsx?tsr-split","app/routes/_layout/_sub-layout/templates.tsx?tsr-split","app/routes/_layout/_sub-layout/create-document.tsx?tsr-split"],"assets":["assets/app-Cs24V_o8.css"]},"app/routes/_auth.tsx?tsr-split":{"file":"assets/_auth-f1uqbOnR.js","name":"_auth","src":"app/routes/_auth.tsx?tsr-split","isDynamicEntry":true},"app/routes/_auth/signin.tsx?tsr-split":{"file":"assets/signin-BCeoXaA7.js","name":"signin","src":"app/routes/_auth/signin.tsx?tsr-split","isDynamicEntry":true,"imports":["_button-cyuXPM3g.js","_input-BNpTjTIy.js","_auth-B0wetoCf.js","_fetch-DqQ3Y-nf.js"]},"app/routes/_auth/signup.tsx?tsr-split":{"file":"assets/signup-BXP0u-i7.js","name":"signup","src":"app/routes/_auth/signup.tsx?tsr-split","isDynamicEntry":true,"imports":["_input-BNpTjTIy.js","_auth-B0wetoCf.js","_fetch-DqQ3Y-nf.js"]},"app/routes/_auth/verify.tsx?tsr-split":{"file":"assets/verify-BBx-LOdE.js","name":"verify","src":"app/routes/_auth/verify.tsx?tsr-split","isDynamicEntry":true,"imports":["_button-cyuXPM3g.js","_input-BNpTjTIy.js","_auth-B0wetoCf.js","_fetch-DqQ3Y-nf.js"]},"app/routes/_layout.tsx?tsr-split":{"file":"assets/_layout-DWkjB2La.js","name":"_layout","src":"app/routes/_layout.tsx?tsr-split","isDynamicEntry":true,"imports":["_input-BNpTjTIy.js","_select-2qGakAU5.js","_button-cyuXPM3g.js","_ssr-C9q5VXgz.js"]},"app/routes/_layout/_sub-layout.tsx?tsr-split":{"file":"assets/_sub-layout-CIAzq0oM.js","name":"_sub-layout","src":"app/routes/_layout/_sub-layout.tsx?tsr-split","isDynamicEntry":true},"app/routes/_layout/_sub-layout/create-document.tsx?tsr-split":{"file":"assets/create-document-CyEbOpXL.js","name":"create-document","src":"app/routes/_layout/_sub-layout/create-document.tsx?tsr-split","isDynamicEntry":true},"app/routes/_layout/_sub-layout/index.tsx?tsr-split":{"file":"assets/index-MG7KYeiH.js","name":"index","src":"app/routes/_layout/_sub-layout/index.tsx?tsr-split","isDynamicEntry":true},"app/routes/_layout/_sub-layout/templates.tsx?tsr-split":{"file":"assets/templates-GPKsuxlM.js","name":"templates","src":"app/routes/_layout/_sub-layout/templates.tsx?tsr-split","isDynamicEntry":true},"app/routes/_layout/dashboard.tsx?tsr-split":{"file":"assets/dashboard-Dj2tCNaX.js","name":"dashboard","src":"app/routes/_layout/dashboard.tsx?tsr-split","isDynamicEntry":true,"imports":["_input-BNpTjTIy.js","_button-cyuXPM3g.js","_select-2qGakAU5.js","_fetch-DqQ3Y-nf.js"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_ssr-C9q5VXgz.js"]}},"server":{"virtual:$vinxi/handler/server":{"file":"entry.mjs","name":"entry","src":"virtual:$vinxi/handler/server","isEntry":true}}};
...
function F$1(e){let n;const t=R(e),s={duplex:"half",method:e.method,headers:e.headers};return e.node.req.body instanceof ArrayBuffer?new Request(t,{...s,body:e.node.req.body}):new Request(t,{...s,get body(){return n||(n=W(e),n)}})}function L$1(e){return e.web??={request:F$1(e),url:R(e)},e.web.request}function H$1(){return S()}const w=Symbol("$HTTPEvent");function O$1(e){return typeof e=="object"&&(e instanceof H3Event||e?.[w]instanceof H3Event||e?.__is_event__===!0)}function l(e){return function(...n){let t=n[0];if(O$1(t))n[0]=t instanceof H3Event||t.__is_event__?t:t[w];else {if(!globalThis.app.config.server.experimental?.asyncContext)throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");if(t=H$1(),!t)throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");n.unshift(t);}return e(...n)}}const R=l(getRequestURL),P$1=l(getResponseStatus),W=l(getRequestWebStream);function I$1(){return getContext("nitro-app",{asyncContext:!!globalThis.app.config.server.experimental?.asyncContext,AsyncLocalStorage:AsyncLocalStorage})}function S(){return I$1().use().event}function U$1(e){return globalThis.MANIFEST[e]}const G$1=eventHandler(j$1);async function j$1(e){return J$1(L$1(e))}async function J$1(e,n){var t,s;const p=e.method,T=new URL(e.url,"http://localhost:3000"),a=Object.fromEntries(T.searchParams.entries()),i=a._serverFnId,d=a._serverFnName;if(!i||!d)throw new Error("Invalid request");g(typeof i=="string","Invalid server action");const b=(s=await((t=U$1("server").chunks[i])==null?void 0:t.import()))==null?void 0:s[d],u=await(async()=>{try{const r=await(async()=>{var y;if((y=e.headers.get("Content-Type"))!=null&&y.includes("multipart/form-data"))return g(p.toLowerCase()!=="get","GET requests with FormData payloads are not supported"),await e.formData();if(p.toLowerCase()==="get")return a.payload?defaultTransformer.parse(a.payload):void 0;const x=await e.text();return defaultTransformer.parse(x)})(),o=await b(r);return o instanceof Response?o:isRedirect$1(o)||isNotFound(o)?v$1(o):new Response(o!==void 0?defaultTransformer.stringify(o):void 0,{status:P$1(S()),headers:{"Content-Type":"application/json"}})}catch(r){return r instanceof Response?r:isRedirect$1(r)||isNotFound(r)?v$1(r):(console.error("Server Fn Error!"),console.error(r),console.info(),new Response(JSON.stringify(r),{status:500,headers:{"Content-Type":"application/json"}}))}})();if(u.headers.get("Content-Type")==="application/json"){const o=await u.clone().text();o&&JSON.stringify(JSON.parse(o));}return u}function v$1(e){const{headers:n,...t}=e;return new Response(JSON.stringify(t),{status:200,headers:{"Content-Type":"application/json",...e.headers||{}}})}
...
function $e(e, r, t) {
  ...
  return P(r, (s, a) => {
    const u = s instanceof ReadableStream ? "stream" : s instanceof Promise ? "promise" : void 0;
    if (u) {
      const c = { dataType: e, type: u, path: a, id: n.length, value: s, matchIndex: t.match.index };
      if (n.push(c), u === "stream") {
        const [l, d] = s.tee();
        return c.streamState = Le({ stream: d }), l;
      } else defer$1(s);
    }
    return s;
  });
...
function Te(e) {
  ...
  const n = t.extracted, [o, s] = ["__beforeLoadContext", "loaderData"].map((a) => n ? n.reduce((u, c) => c.dataType !== a ? H(u, ["temp", ...c.path], void 0) : u, { temp: t[a] }).temp : t[a]);
  if (o !== void 0 || s !== void 0 || (n == null ? void 0 : n.length)) {
    const a = `__TSR__.initMatch(${b({ index: e.matchIndex, __beforeLoadContext: r.options.transformer.stringify(o), loaderData: r.options.transformer.stringify(s), extracted: n ? Object.fromEntries(n.map((u) => [u.id, pick(u, ["type", "path"])])) : {} }, { isScriptContext: true, wrap: true, json: true })})`;
    return jsxs(Fragment, { children: [jsx(ScriptOnce, { children: a }), n ? n.map((u) => u.type === "stream" ? jsx(He, { entry: u }, u.id) : jsx(we, { entry: u }, u.id)) : null] });
  }
  return null;
}
function P(e, r, t = []) {
  if (isPlainArray(e)) return e.map((o, s) => P(o, r, [...t, `${s}`]));
  if (isPlainObject$1(e)) {
    const o = {};
    for (const s in e) o[s] = P(e[s], r, [...t, s]);
    return o;
  }
  const n = r(e, t);
  return n !== e ? n : e;
...
function we({ entry: e }) {
  return jsx("div", { className: "tsr-once", children: jsx(i$3.Suspense, { fallback: null, children: jsx(Pe, { entry: e }) }) });
}
function Pe({ entry: e }) {
  const r = useRouter();
  if (e.value.status === "pending") throw e.value;
  const t = `__TSR__.resolvePromise(${b(e, { isScriptContext: true, wrap: true, json: true })})`;
  return r.injectScript(t), jsx(Fragment, {});
}
function He({ entry: e }) {
  g(e.streamState, "StreamState should be defined");
  const r = useRouter();
  return jsx(B, { streamState: e.streamState, children: (t) => {
    const n = t ? `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.enqueue(new TextEncoder().encode(${b(t.toString(), { isScriptContext: true, wrap: true, json: true })}))` : `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.close()`;
    return r.injectScript(n), jsx(Fragment, {});
  } });
}
function Le({ stream: e }) {
...
function B({ streamState: e, children: r, __index: t = 0 }) {
  const n = e.promises[t];
  if (!n) return null;
  if (n.status === "pending") throw n;
  const o = n.value;
  return jsxs(Fragment, { children: [r(o), jsx("div", { className: "tsr-once", children: jsx(i$3.Suspense, { fallback: null, children: jsx(B, { streamState: e, __index: t + 1, children: r }) }) })] });
}
function H(e, r, t) {
  if (r.length === 0) return t;
  const [n, ...o] = r;
  return Array.isArray(e) ? e.map((s, a) => a === Number(n) ? H(s, o, t) : s) : isPlainObject$1(e) ? { ...e, [n]: H(e[n], o, t) } : e;
}
function M(e) {
  e.router.AfterEachMatch = Te, e.router.serializer = (n) => b(n, { isScriptContext: true, wrap: true, json: true });
  const r = Context.get("TanStackRouterHydrationContext", {}), t = i$3.useMemo(() => {
    var n, o;
...
function Ie(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: Ee(e), url: O(e) }, e.web.request;
}
function Ae() {
  return De();
}
...
function L(e) {
  return function(...r) {
    var _a;
    let t = r[0];
    if (Me(t)) r[0] = t instanceof H3Event || t.__is_event__ ? t : t[F];
    else {
...
const O = L(getRequestURL), qe = L(getResponseHeaders), ke = L(getRequestWebStream);
function We() {
  var _a;
...
function Fe({ createRouter: e, getRouterManifest: r }) {
  return (t) => eventHandler(async (n) => {
    const o = Ie(n), s = new URL(o.url), a = s.href.replace(s.origin, ""), u = createMemoryHistory({ initialEntries: [a] }), c = e();
    c.serializeLoaderData = $e, r && (c.manifest = r()), c.update({ history: u }), await c.load();
    const l = Oe({ event: n, router: c });
    return await t({ request: o, router: c, responseHeaders: l });
  });
}
function Oe(e) {
  e.event.__tsrHeadersSent = true;
  let r = q(qe(e.event), { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((n) => n.headers));
  const { redirect: t } = e.router.state;
  return t && (r = q(r, t.headers, { Location: t.href })), r;
}
function Ne(e) {
  const r = N(() => e.injectedHtml.map((t) => t()).join(""));
...
function je(e) {
  const r = N(() => e.injectedHtml.map((n) => n()).join("")), t = new TextEncoder();
...
const Ue = /(<body)/, ze = /(<\/body>)/, Qe = /(<\/html>)/, Ve = /(<\/[a-zA-Z][\w:.-]*?>)/g, Je = new TextDecoder();
function N(e) {
  let r = false, t = "", n = "";
  return { async transform(o, s) {
    const a = t + Je.decode(o), u = a.match(Ue), c = a.match(ze), l = a.match(Qe);
    try {
      if (u && (r = true), !r) {
        s(a), t = "";
        return;
      ...
      if (c && l && c.index < l.index) {
        const _ = c.index + c[0].length, y = l.index + l[0].length, $ = a.slice(0, _) + d + a.slice(_, y) + a.slice(y);
        s($), t = "";
      } else {
        let _, y = 0;
        for (; (_ = Ve.exec(a)) !== null; ) y = _.index + _[0].length;
        if (y > 0) {
          const $ = a.slice(0, y) + d + n;
          s($), t = a.slice(y);
        } else t = a, n += d;
      }
    } catch (d) {
...
const Ge = async ({ request: e, router: r, responseHeaders: t }) => {
  if (typeof x$1.renderToReadableStream == "function") {
    ...
    const s = [je(r)].reduce((a, u) => a.pipeThrough(u), n);
  ...
  if (typeof x$1.renderToPipeableStream == "function") {
    const n = new PassThrough(), o = x$1.renderToPipeableStream(jsx(M, { router: r }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
      ...
      console.log("Error in renderToPipeableStream:", u, c);
    } }), a = [Ne(r)].reduce((u, c) => u.pipe(c), n);
    return new Response(a, { status: r.state.statusCode, headers: t });
  }
  throw new Error("No renderToReadableStream or renderToPipeableStream found in react-dom/server. Ensure you are using a version of react-dom that supports streaming.");
}, Ze = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/_auth", "/_layout"], preloads: ["/_build/assets/client-Dhg7oJtx.js", "/_build/assets/client-kLIpqcrO.js"] }, "/_auth": { filePath: "_auth.tsx", children: ["/_auth/signin", "/_auth/signup", "/_auth/verify"] }, "/_layout": { filePath: "_layout.tsx", children: ["/_layout/_sub-layout", "/_layout/dashboard"] }, "/_auth/signin": { filePath: "_auth/signin.tsx", parent: "/_auth" }, "/_auth/signup": { filePath: "_auth/signup.tsx", parent: "/_auth" }, "/_auth/verify": { filePath: "_auth/verify.tsx", parent: "/_auth" }, "/_layout/_sub-layout": { filePath: "_layout/_sub-layout.tsx", parent: "/_layout", children: ["/_layout/_sub-layout/create-document", "/_layout/_sub-layout/templates", "/_layout/_sub-layout/"] }, "/_layout/dashboard": { filePath: "_layout/dashboard.tsx", parent: "/_layout" }, "/_layout/_sub-layout/create-document": { filePath: "_layout/_sub-layout/create-document.tsx", parent: "/_layout/_sub-layout" }, "/_layout/_sub-layout/templates": { filePath: "_layout/_sub-layout/templates.tsx", parent: "/_layout/_sub-layout" }, "/_layout/_sub-layout/": { filePath: "_layout/_sub-layout/index.tsx", parent: "/_layout/_sub-layout" } } });
function Ke(e) {
...
function j({ tag: e, attrs: r, children: t }) {
  switch (e) {
    case "title":
...
const et = () => {
  const e = useRouter(), r = useRouterState({ select: (s) => s.matches.map((a) => a.meta).filter(Boolean) }), t = i$3.useMemo(() => {
    const s = [], a = {};
    let u;
    return [...r].reverse().forEach((c) => {
      [...c].reverse().forEach((l) => {
        if (l) if (l.title) u || (u = { tag: "title", children: l.title });
        else {
          if (l.name) {
            if (a[l.name]) return;
            a[l.name] = true;
          }
          s.push({ tag: "meta", attrs: { ...l } });
        }
      });
    }), u && s.push(u), s.reverse(), s;
    ...
    const a = [];
    return s.matches.map((u) => e.looseRoutesById[u.routeId]).forEach((u) => {
      var c, l, d;
      return (d = (l = (c = e.manifest) == null ? void 0 : c.routes[u.id]) == null ? void 0 : l.preloads) == null ? void 0 : d.filter(Boolean).forEach((_) => {
        a.push({ tag: "link", attrs: { rel: "modulepreload", href: _ } });
      });
    }), a;
  }, structuralSharing: true });
  return nt([...t, ...o, ...n], (s) => JSON.stringify(s));
}, tt = () => {
  const e = useRouter(), r = et(), t = i$3.useContext(Context.get("TanStackRouterHydrationContext", {}));
  return jsxs(Fragment, { children: [r.map((n, o) => createElement(j, { ...n, key: `tsr-meta-${JSON.stringify(n)}` })), jsxs(Fragment, { children: [jsx(ScriptOnce, { log: false, children: '__TSR__={matches:[],streamedValues:{},queue:[],runQueue:()=>{let e=!1;__TSR__.queue=__TSR__.queue.filter((_=>!_()||(e=!0,!1))),e&&__TSR__.runQueue()},initMatch:e=>{__TSR__.queue.push((()=>(__TSR__.matches[e.index]||(__TSR__.matches[e.index]=e,Object.entries(e.extracted).forEach((([e,_])=>{if("stream"===_.type){let e;_.value=new ReadableStream({start(_){e=_}}),_.value.controller=e}else if("promise"===_.type){let e,t;_.value=new Promise(((_,u)=>{e=_,t=u})),_.resolve=e,_.reject=t}}))),!0))),__TSR__.runQueue()},resolvePromise:e=>{__TSR__.queue.push((()=>{const _=__TSR__.matches[e.matchIndex];if(_){const t=_.extracted[e.id];if(t)return t.resolve(e.value.data),!0}return!1})),__TSR__.runQueue()},cleanScripts:()=>{document.querySelectorAll(".tsr-once").forEach((e=>{e.remove()}))}};' }), jsx(ScriptOnce, { children: `__TSR__.dehydrated = ${b(e.options.transformer.stringify(t), { isScriptContext: true, wrap: true, json: true })}` })] })] });
}, rt = () => jsx(Fragment, { children: tt() });
function nt(e, r) {
...
const ot = () => {
  const e = useRouter(), r = useRouterState({ select: (o) => {
    ...
    return o.matches.map((a) => e.looseRoutesById[a.routeId]).forEach((a) => {
      var u, c, l;
      return (l = (c = (u = e.manifest) == null ? void 0 : u.routes[a.id]) == null ? void 0 : c.assets) == null ? void 0 : l.filter((d) => d.tag === "script").forEach((d) => {
  ...
  return jsx(Fragment, { children: n.map((o, s) => createElement(j, { ...o, key: `tsr-scripts-${o.tag}-${s}` })) });
}, st = "/_build/assets/app-Cs24V_o8.css", at = createContext$1({ counter: 0, setCounter: () => {
} }), U = ({ children: e }) => {
  const [r, t] = useState(0);
  return jsx(at.Provider, { value: { counter: r, setCounter: t }, children: e });
}, E = createRootRouteWithContext()({ context: () => U, head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "Esigns" }] }), component: ut });
function ut() {
  return jsx(Fragment, { children: jsx(U, { children: jsxs(it, { children: [jsx(Outlet, {}), jsx(Toaster, { richColors: true, closeButton: true, position: "top-right" })] }) }) });
}
function it({ children: e }) {
  return jsxs("html", { children: [jsxs("head", { children: [jsx(rt, {}), jsx("link", { rel: "stylesheet", href: st })] }), jsxs("body", { children: [e, jsx(ScrollRestoration, {}), jsx(ot, {})] })] });
}
const ct = () => import('../build/_layout-DWkjB2La.mjs'), z = createFileRoute("/_layout")({ component: lazyRouteComponent(ct, "component", () => z.ssr) }), lt = () => import('../build/_auth-f1uqbOnR.mjs'), Q = createFileRoute("/_auth")({ component: lazyRouteComponent(lt, "component", () => Q.ssr) }), dt = () => import('../build/dashboard-Dj2tCNaX.mjs'), V = createFileRoute("/_layout/dashboard")({ component: lazyRouteComponent(dt, "component", () => V.ssr) }), pt = () => import('../build/_sub-layout-CIAzq0oM.mjs'), J = createFileRoute("/_layout/_sub-layout")({ component: lazyRouteComponent(pt, "component", () => J.ssr) }), mt = () => import('../build/verify-BBx-LOdE.mjs'), G = createFileRoute("/_auth/verify")({ component: lazyRouteComponent(mt, "component", () => G.ssr) }), ht = () => import('../build/signup-BXP0u-i7.mjs'), Z = createFileRoute("/_auth/signup")({ component: lazyRouteComponent(ht, "component", () => Z.ssr) }), ft = () => import('../build/signin-BCeoXaA7.mjs'), K = createFileRoute("/_auth/signin")({ component: lazyRouteComponent(ft, "component", () => K.ssr) }), _t = () => import('../build/index-MG7KYeiH.mjs'), X = createFileRoute("/_layout/_sub-layout/")({ component: lazyRouteComponent(_t, "component", () => X.ssr) }), yt = () => import('../build/templates-GPKsuxlM.mjs'), Y = createFileRoute("/_layout/_sub-layout/templates")({ component: lazyRouteComponent(yt, "component", () => Y.ssr) }), gt = () => import('../build/create-document-CyEbOpXL.mjs'), ee = createFileRoute("/_layout/_sub-layout/create-document")({ component: lazyRouteComponent(gt, "component", () => ee.ssr) }), I = z.update({ id: "/_layout", getParentRoute: () => E }), C = Q.update({ id: "/_auth", getParentRoute: () => E }), Rt = V.update({ id: "/dashboard", path: "/dashboard", getParentRoute: () => I }), v = J.update({ id: "/_sub-layout", getParentRoute: () => I }), St = G.update({ id: "/verify", path: "/verify", getParentRoute: () => C }), bt = Z.update({ id: "/signup", path: "/signup", getParentRoute: () => C }), xt = K.update({ id: "/signin", path: "/signin", getParentRoute: () => C }), Ct = X.update({ id: "/", path: "/", getParentRoute: () => v }), vt = Y.update({ id: "/templates", path: "/templates", getParentRoute: () => v }), $t = ee.update({ id: "/create-document", path: "/create-document", getParentRoute: () => v }), Tt = { AuthSigninRoute: xt, AuthSignupRoute: bt, AuthVerifyRoute: St }, wt = C._addFileChildren(Tt), Pt = { LayoutSubLayoutCreateDocumentRoute: $t, LayoutSubLayoutTemplatesRoute: vt, LayoutSubLayoutIndexRoute: Ct }, Ht = v._addFileChildren(Pt), Lt = { LayoutSubLayoutRoute: Ht, LayoutDashboardRoute: Rt }, Et = I._addFileChildren(Lt), It = { AuthRoute: wt, LayoutRoute: Et }, At = E._addFileChildren(It)._addFileTypes(), Mt = () => jsxs("div", { children: [jsx("h1", { children: "404" }), jsx("p", { children: "Not Found" })] });
function qt() {
  const e = new QueryClient();
  return routerWithQueryClient(createRouter$2({ routeTree: At, context: { queryClient: e }, defaultPreload: "intent", defaultNotFoundComponent: Mt }), e);
}
const Kt = Fe({ createRouter: qt, getRouterManifest: Ye })(Ge);
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/saichandrajagu/Documents/Oro_projects/esigns/app.esigns.com/.data/kv"}));
...
export { at as a, listener as l, node$1 as n };
